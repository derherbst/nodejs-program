...
export const CREATE_TABLE_USERS = 'CREATE TABLE IF NOT EXISTS "users" ("id" UUID NOT NULL , "login" VARCHAR(255) NOT NULL, "password" VARCHAR(255) NOT NULL, "age" INTEGER NOT NULL, "isDeleted" BOOLEAN NOT NULL, PRIMARY KEY ("id"));';
export const DROP_TABLE_USERS = 'DROP TABLE "users";';

export const CREATE_TABLE_GROUPS = 'CREATE TABLE IF NOT EXISTS "groups" ("id" UUID NOT NULL , "name" VARCHAR(255) NOT NULL, "permissions" ARRAY(STRING) NOT NULL);';
